        ...
        <div class="container d-flex align-items-center">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item"><a href="DoctorCare/index.html" class="nav-link pl-0">Home</a></li>

                <li class="nav-item"><a href="http://localhost:8080/CSE299/registration/completeProfile.php" class="nav-link">Complete Profile</a></li>

                <li class="nav-item"><a href="http://localhost:8080/CSE299/registration/medicalHistory.php" class="nav-link">Medical History</a></li>

                <li class="nav-item"><a href="http://localhost:8080/CSE299/registration/aboutUser.php" class="nav-link">About me</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
         <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Welcome!</h1>
